...
import 'schema/confirmados_record.dart';
...
export 'schema/confirmados_record.dart';
...
/// Functions to query ConfirmadosRecords (as a Stream and as a Future).
Future<int> queryConfirmadosRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ConfirmadosRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ConfirmadosRecord>> queryConfirmadosRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ConfirmadosRecord.collection(parent),
      ConfirmadosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ConfirmadosRecord>> queryConfirmadosRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
